...
#define ATECAT_VERS_BUILD           23   /* build number */              
#define ATECAT_VERSION (  (ATECAT_VERS_MAJ << 3*8)              \
                        | (ATECAT_VERS_MIN << 2*8)              \
                        | (ATECAT_VERS_SERVICEPACK << 1*8)      \
                        | (ATECAT_VERS_BUILD << 0*8)            \
                       )
#define ATECAT_FILEVERSION      2,9,2,23 
#if (defined EVAL_VERSION) 
#define ATECAT_FILEVERSIONSTR   "2.9.2.23 (Protected)\0" 
#else 
#define ATECAT_FILEVERSIONSTR   "2.9.2.23\0" 
#endif   
#define ATECAT_PRODVERSION      ATECAT_FILEVERSION 
#define ATECAT_PRODVERSIONSTR   ATECAT_FILEVERSIONSTR 
#define ATECAT_COPYRIGHT        "Copyright acontis technologies GmbH @ 2018\0" 
