 ...
 * ----------------------------------------------------------------------------
 * 05Jun18 | 17| Fix: MC_TrajSetupJerkMove()
 *         |   | In case of distance=1 compared with IncPerMM=1 and IncFactor=0, 
 *         |   | the function failed with error code MC_ERR_CALC_RAMPS_TO_BIG
 * ----------------------------------------------------------------------------
