...
#define SEVENTEEN_MS_DELAY					((17 * sysClkRateGet()) / 1000)

/* Event registers */
#define CTRL_250us							0x01
#define	CON_EVENT							0x02
#define	IO_IMAGE_HANDLE_EVENT				0x03
#define	MAILBOX_HANDLE_EVENT				0x04
...
/* Macro define for the change in CIP Object model - Used in EthernetIP */
#define SCBL_EIP_ACD_INFO_REQ				391
#define UIC_EIP_ACD_INFO_RES				392
#define SCBL_EIP_IP_CONFIG_REQ              393
#define UIC_EIP_IP_CONFIG_RES               394		//<! Future use of the response packet after HMI screen development
