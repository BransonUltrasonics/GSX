...
#define EIP_OBJECT_PRM_ENABLE_NEW_CONNECTION_IND_BEHAVIOR        0x00000020 /*<! This flag, if set, changes the semantics of the EIP_OBJECT_CONNECTION_IND packet.
                                                                                 The connection indication, for CIP class 0/1 target connections, will then be generated
                                                                                 as soon as the ForwardOpen request has successfully been processed.
                                                                                 Per default, or when the flag is not set (0), it is generated when the first I/O frame was
                                                                                 received from the originator. All newer stack versions will implement the new behavior as the default behavior.
                                                                                 Therefore, this parameter is depecated and will be removed for future versions.

                                                                                 Please refer to ticket PSEIP-625 for further details.
                                                                            */
